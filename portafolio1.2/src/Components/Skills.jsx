...
export default function Skills(){
    return(
        ...
        <div className="skills-container" >
            ...
            <p className="skillsParragraph">Throughout my classes, extracurricular Coding competitions and classes I’ve come to develop several programing skills; During courses and ICPC’s tournaments I’ve practiced solving and optimizing complex problems using data structures mainly with Python and in some cases C++. During my free Time and as a side-hustle I Learned the basics of Web Development using HTML, CSS and Java Script. For hackathons on the other hand, I’ve practiced a wider set of skills using a couple of frameworks to develop the frontend side of apps like React Native and Kivy.  I’ve also got the opportunity to work on a web app as a full-time developer for an education social project, during this time I learned how to use React To build functional Web Apps incorporating Node.js for the back-end and Mongo as non-relational data base</p>
